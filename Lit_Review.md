...
[Definition of VCID](https://www.ninds.nih.gov/current-research/focus-disorders/alzheimers-disease-and-related-dementias/focus-vascular-contributions-cognitive-impairment-and-dementia-vcid)


# Paper: 
## Eric E. Smith, Hugo J. Aparicio, Rebecca F. Gottesman, Manu S. Goyal, Steven M. Greenberg, Julie A. Schneider, Farzaneh A. Sorond, and Clinton B. Wright on behalf of the American Heart Association Stroke Council; Council on Cardiovascular and Stroke Nursing; and Council on Peripheral Vascular Disease (2025) Vascular Contributions to Cognitive Impairment and Dementia in the United States: Prevalence and Incidence: A Scientific Statement From the American Heart Association [Source](https://www.ahajournals.org/doi/epub/10.1161/STR.0000000000000494)

* Large discrepancy in how many cases of VCID vs healthcare billing
    * Data suggests 2.7 million people over 65 have VCID or Mixed Dementia while healthcare billing shows approx 800k diagnosis 


* “Although vascular dementia is common, its epidemiology has not been fully defined”
    * This includes biomarkers and patterns for who gets it and why
    * “​​Challenges to defining the epidemiology of vascular dementia include the lack of a single highly specific biomarker…”
* “Identifying earlier biomarkers of processes leading to neurodegeneration, cerebrovascular disease, and dementia may facilitate earlier treatment and prevention.” 
    * The purpose of this project- is this achievable? 
    * Include Neuroimaging
* Limitations 
    * Diagnostic Reporting is NOT standardized
    * Variability of different models
    * “estimate in the literature for vascular dementia incidence is lacking”
        * “Relatively few epidemiological studies classify the different forms of dementia by underlying type”
        * Where do we start/what is the definition? 

These show the importance of moving from a descriptive epidemiology to more measurable risk predictions for VCID 

# Paper 

## Lennon, M.J., Karvelas, N., Ganesh, A. et al. The future of biomarkers for vascular contributions to cognitive impairment and dementia (VCID): proceedings of the 2025 annual workshop of the Albert research institute for white matter and cognition. GeroScience 47, 6177–6190 (2025). [Source](https://link.springer.com/article/10.1007/s11357-025-01746-y)

* "emphasis on identifying VCID where it occurs rather than being confined by traditional clinical diagnostic boundaries"
  * Dementia risk increases as the amount of coexisiting biomarkers increase 
* Critical Goal Is to further develop VCID biomarkers at all levels 
* MRIs most widly used technique to asses cSVD (cerebral small vessel disease)
* Markers in biological fluids like plasma and cerebrospinal fluid - connects to the inflammatory markers mentioned in project description



# Paper 

## Xu LZ, Li FY, Xu J, Li BQ, Li Y, Jia JP. Vascular endothelial growth factor is an effective biomarker for vascular dementia, not for Alzheimer's disease: A meta-analysis. Alzheimers Dement (Amst). 2024 Jun 22;16(2):e12612. doi: 10.1002/dad2.12612. PMID: 38912304; PMCID: PMC11193096. [Source](https://pubmed.ncbi.nlm.nih.gov/38912304/)

* 24 studies (low but a start?)
* VEGF levels high in VCID patients vs overall Alzheimers Disease patients 
* Could complement with other biomarkers to improve predictions 

# Paper: 

## Wang Q, Zhang L, Xu R, Meng K, Pan L, Zhang X, Ge L, Zhu D. Metabolic syndrome and risk of dementia and cognitive decline: a systematic review and meta-analysis of prospective cohort studies from 6,753,197 participants. Geroscience. 2025 Nov 18. doi: 10.1007/s11357-025-02014-9. Epub ahead of print. PMID: 41252085. [Source](https://link.springer.com/article/10.1007/s11357-025-02014-9)

* Links to overall cognitive decline (not just VCID) are inconsistent 
  * All cause - 1.11 increase (2 per 1000 people)
  * VCID 1.33 (7 more per 1000)
  * NOT associated with Alzheimers disease 
* MetS could be a core predictor 
* Since this project could work on combined biomarker scores Mets should be investigate alongside other to improve accuracy 

# Paper 
## Menart AC, Tap L, Wolters FJ, Mattace-Raso F. Vascular cognitive impairment and dementia in old age: cognition and beyond. Age Ageing. 2025 Oct 30;54(11):afaf298. doi: 10.1093/ageing/afaf298. PMID: 41177547. [Source](https://pubmed.ncbi.nlm.nih.gov/41177547/)
* VCID Common in aging adults 
